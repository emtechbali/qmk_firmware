...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   *
   * ,-------------------------------------------.                         ,-------------------------------------------.
   * | L1/ESC |   Q  |   W  |   F  |   P  |   B  |                         |   J  |   L  |   U  |   Y  | ; :  |  | \   |
   * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
   * |Ctrl/BS |   A  |   R  |  S   |   T  |   G  | RMB  |           | FUNC |   K  |   N  |   E  |   I  |   o  |  ' "   |
   * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
   * | LShift |   Z  |   X  |   C  |   D  |   V  | LMB  |           |      |   M  |   H  | ,  < | . >  | /  ? |  - _   |
   * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
   *                    .----------.   .-------.                                 .------.   .-----.
   ...
   */
  [BASE] = LAYOUT_GERGO(
  LT(NUMB, KC_ESC),       KC_Q,  KC_W,   KC_F,   KC_P, KC_B,                           KC_J, KC_L, KC_U,    KC_Y,   KC_SCLN, KC_PIPE,
  MT(MOD_LCTL, KC_BSPC),  KC_A,  KC_R,   KC_S,   KC_T, KC_G, KC_BTN2,       TT(FUNK),  KC_K, KC_N, KC_E,    KC_I,   KC_O,    KC_QUOT,
  KC_RSFT,                KC_Z,  KC_X,   KC_C,   KC_D, KC_V, KC_BTN1,       KC_BSPC,   KC_M, KC_H, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
 ...
 */
[FUNK] = LAYOUT_GERGO(  
KC_TRNS, KC_1, 	  KC_2,    KC_3,    KC_4,    KC_5,                             KC_6,    KC_UP,    KC_UP,    KC_9,    KC_0,    KC_TRNS, 
KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,         KC_TRNS,  KC_LEFT, KC_LEFT, KC_DOWN,   KC_RGHT, KC_VOLD, KC_VOLU, 
