...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [BASE] = LAYOUT_GERGO(
  LT(NUMB, KC_ESC),       KC_Q,  KC_W,   KC_F,   KC_P, KC_G,                           KC_J, KC_L, KC_U,    KC_Y,   KC_SCLN, KC_PIPE,
...
KC_TRNS, KC_Q, KC_W, KC_E, KC_R, KC_T , KC_TRNS,       FLSH,    KC_PMNS, KC_4,    KC_5,    KC_6,    KC_PAST, KC_EQL, 
