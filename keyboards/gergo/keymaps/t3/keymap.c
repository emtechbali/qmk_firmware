...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   *
   * ,-------------------------------------------.                         ,-------------------------------------------.
   * | L1/ESC |   Q  |   W  |   F  |   J  |   G  |                         |   Y  |   U  |   I  |   O  |   P  |  | \   |
   * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
   * |Ctrl/BS |   A  |   R  |  S   |   T  |   D  | RMB  |           | FUNC |   H  |   N  |   E  |   L  | ;  : |  ' "   |
   * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
   ...
   */
  [BASE] = LAYOUT_GERGO(
  LT(NUMB, KC_ESC),       KC_Q,  KC_W,   KC_F,   KC_J, KC_G,                       KC_Y,    KC_U, KC_I, KC_O,   KC_P,    KC_PIPE,
  MT(MOD_LCTL, KC_BSPC),  KC_A,  KC_R,   KC_S,   KC_T, KC_D, KC_BTN2,       TT(FUNK),  KC_H,    KC_N, KC_E, KC_L,   KC_SCLN, KC_QUOT,
